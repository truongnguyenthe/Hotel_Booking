        ...
        <div class="card shadow-lg p-4 rounded-3" style="width: 500px; background: #f8f9fa;">
            ...
            <form action="{{ route('rooms.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control rounded-pill px-3 @error('name') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="price" class="form-control rounded-pill px-3 @error('price') is-invalid @enderror"
